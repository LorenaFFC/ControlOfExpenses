    ...
    public partial class ExpenseReport : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            var conection = ConnectionManager.GetSqlConnection();
                    string query = "UPDATE [Financial].[dbo].[EXPENDITURE] SET [CLASSIFICATION] = @CLASSIFICATION,[EXPENDITURE_DATE] = @EXPENDITURE_DATE ,[UNITARY_VALUE] = @UNITARY_VALUE,[AMOUNT] = @AMOUNT,[TOTAL_VALUE] =  @UNITARY_VALUE * @AMOUNT  ,[FORM_PAYMENT] = @FORM_PAYMENT, [STATUS] = @STATUS WHERE ID = @ID";
